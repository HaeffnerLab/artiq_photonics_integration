...
class Raman_SBC_AmpRamanScan(_ACFExperiment):
    ...
    def prepare(self):
        self.fitting_func.setup(len(self.scan_amp_Raman.sequence))
        # Create datasets
        num_freq_samples = len(self.scan_amp_Raman.sequence)
        ...
        self.experiment_data.set_list_dataset("amplitude", num_freq_samples, broadcast=True)
    ...
    def run(self):
        ...
        while time_i < len(self.scan_amp_Raman.sequence):
            
            amp_Raman=self.scan_amp_Raman.sequence[time_i]
            ...
            while sample_num<self.samples_per_time:
                if is_ion_good:
                    ...
                    self.seq.sideband_Raman.run(amp_Ramam_here=amp_Raman)
            ...
            self.experiment_data.append_list_dataset("amplitude", amp_Raman)

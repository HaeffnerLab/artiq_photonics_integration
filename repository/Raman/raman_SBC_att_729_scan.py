...
class RamanAtt729Scan_SBC(_ACFExperiment):
    ...
    def prepare(self):
        self.fitting_func.setup(len(self.scan_att_729_dp.sequence))
        # Create datasets
        num_freq_samples = len(self.scan_att_729_dp.sequence)
    ...
    def run(self):
        ...
        while time_i < len(self.scan_att_729_dp.sequence):
            
            att_729_dp_SBC=self.scan_att_729_dp.sequence[time_i]
            ...
            while sample_num<self.samples_per_time:
                if is_ion_good:
                    ...
                    self.seq.sideband_Raman.run(att_729_dp_here=att_729_dp_SBC)
            ...
            self.experiment_data.append_list_dataset("attenuation", att_729_dp_SBC)

...
class A6_854_decay_rate(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.setup_fit(fitting_func, 'Exp_decay' ,-999)
    ...
    def rabi_AWG(self, pulse_time):
        ...
        self.dds_866_dp.set(self.freq_854)
        self.dds_866_dp.set_att(self.att_866)

        if (pulse_time>0.2*us):
    ...
    def exp_seq(self, rabi_t, ion_status_detect):
        ...
        # rabi 
        self.rabi_AWG(rabi_t)#, self.freq_729_dp+self.freq_diff_dp, self.att_729_dp)

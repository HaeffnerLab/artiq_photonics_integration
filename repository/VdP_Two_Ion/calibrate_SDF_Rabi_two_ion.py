...
class Calibration_SDF_Rabi_Two_Ion(EnvExperiment):
    ...
    def build(self):
        ...
        self.setattr_argument(
            ...
            NumberValue(default=3, precision=0, step=1),
    ...
    def prepare(self):
        ...
        expid_4_1= {
            ...
            "arguments": { 
                "scan_rabi_t": {"start": 0.0*us, "stop": 15.*us, "npoints": 30, "randomize": False,  "ty": "RangeScan"},
                "att_729_dp":self.get_dataset("__param__VdP2mode/att_729_dp"),
                "att_729_sp":self.get_dataset("__param__VdP2mode/att_729_mode1_2RSB"),
                "power_calibration": "VdP2mode/Rabi_Freq_mode1_2RSB",
                "cooling_option": cooling_option,
                #"Rabi_freq":self.get_dataset("__param__VdP2mode/Rabi_Freq_mode1_2RSB"),
                },
            "log_level": 10,
            "repo_rev": "N/A"
            }
        expid_4_2 = {
            ...
            "class_name": "A6_Rabi_Time_Cam",
            "arguments": { 
                "scan_rabi_t": {"start": 0.0*us, "stop": 30.*us, "npoints": 30, "randomize": False,  "ty": "RangeScan"},
                "att_729_dp":self.get_dataset("__param__VdP2mode/att_729_dp"),
                "att_729_sp":self.get_dataset("__param__VdP2mode/att_729_mode1_BSB"),
                "power_calibration": "VdP2mode/Rabi_Freq_mode1_BSB",
                "cooling_option": cooling_option,
                #"Rabi_freq":self.get_dataset("__param__VdP2mode/Rabi_Freq_mode1_BSB"),
                },
            "log_level": 10,
            "repo_rev": "N/A"
            }
        expid_4_3 = {
            ...
            "arguments": { 
                ...
                "power_calibration": "VdP2mode/Rabi_Freq_mode2_BSB",
                "cooling_option": cooling_option,
                ##"Rabi_freq":self.get_dataset("__param__VdP2mode/Rabi_Freq_mode2_BSB"),
                },
            "log_level": 10,
            "repo_rev": "N/A"
            }
        ...
        expid_4_4 = {
            ...
            "arguments": { 
                ...
                "power_calibration": "VdP2mode/Rabi_Freq_mode2_2RSB",
                "cooling_option": cooling_option,
                #"Rabi_freq":self.get_dataset("__param__VdP2mode/Rabi_Freq_mode2_2RSB"),
                },
            "log_level": 10,
            "repo_rev": "N/A"
            }
        ...
        expid_5_1 = {
            ...
            "arguments": { 
                "vib_mode": "mode1",
                "cooling_option": cooling_option,
                "scan_amp_729_sp_aux":{"start": self.get_dataset("__param__SDF/mode1/amp_729_sp_aux")-0.02, "stop": self.get_dataset("__param__SDF/mode1/amp_729_sp_aux")+0.02, "npoints": 10, "randomize": True,  "ty": "RangeScan"},
                "rabi_t": 12.0*us
                },
            "log_level": 10,
            "repo_rev": "N/A"
        ...
        expid_5_2 = {
            ...
            "arguments": { 
                "vib_mode": "mode2",
                "cooling_option": cooling_option,
                "scan_amp_729_sp_aux":{"start": self.get_dataset("__param__SDF/mode2/amp_729_sp_aux")-0.02, "stop": self.get_dataset("__param__SDF/mode2/amp_729_sp_aux")+0.02, "npoints": 10, "randomize": True,  "ty": "RangeScan"},
                "rabi_t": 12.0*us
                },
            "log_level": 10,
            "repo_rev": "N/A"
        ...
        expid_6_1 = {
            ...
            "arguments": { 
                "scan_rabi_t": {"start": 0.0*us, "stop": 100.*us, "npoints": 30, "randomize": False,  "ty": "RangeScan"},
                "freq_729_dp":self.get_dataset("__param__qubit/Sm1_2_Dm5_2")+self.get_dataset("__param__VdP2mode/vib_freq1")/2.0,
                "vib_mode": "mode1",
                "freq_delta_m": 0.0,
                "power_calibration":"SDF/mode1/Rabi_Freq",
                "cooling_option": cooling_option
                },
            "log_level": 10,
            "repo_rev": "N/A"
        ...
        expid_6_3 = {
            ...
            "arguments": { 
                "scan_rabi_t": {"start": 0.0*us, "stop": 30.*us, "npoints": 30, "randomize": False,  "ty": "RangeScan"},
                "freq_729_dp":self.get_dataset("__param__qubit/Sm1_2_Dm5_2")+self.get_dataset("__param__VdP2mode/vib_freq2")/2.0,
                "vib_mode": "mode2",
                "freq_delta_m": 0.0,
                "power_calibration":"SDF/mode2/Rabi_Freq",
                "cooling_option": cooling_option
                },
            "log_level": 10,
            "repo_rev": "N/A"
        ...
        expid_6_4 = {
            ...
            "arguments": { 
                "scan_rabi_t": {"start": 0.0*us, "stop": 30.*us, "npoints": 30, "randomize": False,  "ty": "RangeScan"},
                "freq_729_dp":self.get_dataset("__param__qubit/Sm1_2_Dm1_2")-self.get_dataset("__param__VdP2mode/vib_freq2")/2.0,
                "vib_mode": "mode2",
                "freq_delta_m": 0.0,
                "power_calibration":"SDF/mode2/Rabi_Freq",
                "cooling_option": cooling_option

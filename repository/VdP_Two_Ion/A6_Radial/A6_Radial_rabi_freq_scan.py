...
class Rabi_Freq(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.setattr_argument(
            ...
            Scannable(
                default=RangeScan(
                    start=self.parameter_manager.get_param("qubit/Sm1_2_Dm5_2")-0.002*MHz,
                    stop=self.parameter_manager.get_param("qubit/Sm1_2_Dm5_2")+0.002*MHz,
                    npoints=40
                ),
                global_min=150*MHz,
                global_max=250*MHz,
    ...
    def analyze(self):
        ...
        with self.interactive("Ca+ line") as inter:
            inter.setattr_argument(
                "Ca_line", 
                EnumerationValue(["Sm1_2_Dm1_2", "Sm1_2_Dm5_2", "single_ion_Radial", "nothing"]
                                 , default="Sm1_2_Dm5_2")
            )

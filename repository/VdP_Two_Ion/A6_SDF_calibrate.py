...
class A6_SDF_calibrate_AWG_Cam(_ACFExperiment):
    ...
    def prepare(self):
        ...
        if self.vib_mode=="mode1":
            ...
            del_m=self.parameter_manager.get_param("VdP2mode/Rabi_Freq_SDF_mode1_delta_m") if "Scan_Type"=='Delta_s' else 0
            del_s=self.parameter_manager.get_param("VdP2mode/Rabi_Freq_SDF_mode1_delta_s") if "Scan_Type"=='Delta_m' else 0
            
            self.amp_729_sp=self.parameter_manager.get_param("VdP2mode/amp_729_mode1_sp")
            self.amp_729_sp_aux=self.parameter_manager.get_param("VdP2mode/amp_729_mode1_sp_aux")
            ...
            del_m=self.parameter_manager.get_param("VdP2mode/Rabi_Freq_SDF_mode2_delta_m") if "Scan_Type"=='Delta_s' else 0
            del_s=self.parameter_manager.get_param("VdP2mode/Rabi_Freq_SDF_mode2_delta_s") if "Scan_Type"=='Delta_m' else 0

            self.amp_729_sp=self.parameter_manager.get_param("VdP2mode/amp_729_mode2_sp")
            self.amp_729_sp_aux=self.parameter_manager.get_param("VdP2mode/amp_729_mode2_sp_aux")
            ...
            del_m=self.parameter_manager.get_param("SDF/delta_m") if "Scan_Type"=='Delta_s' else 0
            del_s=self.parameter_manager.get_param("SDF/delta_s") if "Scan_Type"=='Delta_m' else 0

            self.amp_729_sp=self.parameter_manager.get_param("SDF/amp_729_sp")
            self.amp_729_sp_aux=self.parameter_manager.get_param("SDF/amp_729_sp_aux")
    ...
    def analyze(self):        
        ...
        if self.Scan_Type == 'Delta_s':
            match self.vib_mode:
                case "mode2":
                    param_name="VdP2mode/Rabi_Freq_SDF_mode2_delta_s"
                case "mode1":
                    param_name="VdP2mode/Rabi_Freq_SDF_mode1_delta_s"       
                case "mode_single_ion":
                    param_name="SDF/delta_s"

        elif self.Scan_Type == 'Delta_m':
            match self.vib_mode:
                case "mode2":
                    param_name="VdP2mode/Rabi_Freq_SDF_mode2_delta_m"
                case "mode1":
                    param_name="VdP2mode/Rabi_Freq_SDF_mode1_delta_m"       
                case "mode_single_ion":
                    param_name="SDF/delta_m"

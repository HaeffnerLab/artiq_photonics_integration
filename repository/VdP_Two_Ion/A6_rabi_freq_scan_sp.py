    ...
    def analyze(self):
        ...
        with self.interactive("Ca+ sideband") as inter:
            inter.setattr_argument(
                "Ca_line", 
                EnumerationValue(["2RSB_mode1", "2RSB_mode2","BSB_mode2","BSB_mode1","RSB_mode2","RSB_mode1", "2RSB_mode_single_ion", "BSB_mode_single_ion", "nothing"]
                                 , default=self.Ca_line)
            )
        
        freq_sp=self.get_dataset("__param__frequency/729_sp")
        
        if inter.Ca_line == "2RSB_mode1":
        ...
        elif inter.Ca_line == "BSB_mode_single_ion":
        ...
        elif inter.Ca_line == "2RSB_mode_single_ion":

...
class track_carrier_with_ramsey(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.seq.adjust_729_freq_ramsey.build()
    ...
    def prepare(self):
        ...
        self.experiment_data.set_list_dataset("carrier_freq", self.num_samples, broadcast=True)
    ...
    def run(self):
        ...
        while i < self.num_samples:
            ...
            ion_status_detect=self.seq.adjust_729_freq_ramsey.calibrate_freq_qubit(
                line="Sm1_2_Dm5_2", 

...
class att854_scan(_ACFExperiment):
    ...
    @kernel
    def exp_seq(self, freq_729_dp_vib, att_854_dp, ion_status_detect):
        #854 repump
        ...
        while i < len(self.scan_att_854.sequence):
            ...
            while sample_num<self.samples_per_time:
                if ion_status_detect==1 or ion_status_detect==2:
                    ...
                    self.exp_seq(freq_729_dp_vib, att_854_dp, ion_status_detect)
                    ################################################################################

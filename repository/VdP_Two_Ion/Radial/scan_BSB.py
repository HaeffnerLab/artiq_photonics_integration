...
class scan_BSB_Time_One_Ion_Radial(EnvExperiment):
    ...
    def submit_BSB_mode1(self, 
        ...
        expid_3_1 = {
            ...
            "arguments": {
                ...
                "freq_729_dp": self.get_dataset("__param__qubit/Sm1_2_Dm5_2")-self.vib_freq0_1/2.0,
                "att_729_dp": 10.0*dB,
    ...
    def submit_BSB_mode2(self, 
        ...
        expid_3_1 = {
            ...
            "arguments": {
                ...
                "freq_729_dp": self.get_dataset("__param__qubit/Sm1_2_Dm5_2")-self.vib_freq0_2/2.0,
                "att_729_dp": 10.0*dB,
                "cooling_option": "sidebandcool_Radial"
                },
            "log_level": 10,
...
############################################################################################################
        ...
        if self.enable_BSB_mode1:
            rid=self.submit_BSB_mode1()
            time.sleep(1)
            while True:
                if self.check_status(rid):
                    break
            time.sleep(2)
        if self.enable_BSB_mode2:
            rid=self.submit_BSB_mode2()
            time.sleep(1)
            while True:
                if self.check_status(rid):
                    break

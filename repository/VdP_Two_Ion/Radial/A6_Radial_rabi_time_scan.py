...
class Rabi_Time(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.setattr_argument(
            "PI_att_729_dp",
            NumberValue(default=self.parameter_manager.get_param("pi_time/Radial/att_729_dp"), min=0.0, max=30.0, unit="dB", precision=8),
            tooltip="729 double pass frequency for resonance",
            group='Pi pulse excitation'
        )
        self.setattr_argument(
        ...
        self.setattr_argument(
            "PI_att_729_sp",
            NumberValue(default=self.parameter_manager.get_param("attenuation/729_radial_sp"), min=0, max=1, precision=8),
            tooltip="729 double pass amplitude for resonance",
            group='Pi pulse excitation'
        )
        self.setattr_argument(
            "PI_drive_time",
            NumberValue(default=self.parameter_manager.get_param("pi_time/Radial/pi_time"), min=0.*us, max=1000*us, unit='us', precision=8),
    ...
    def rabi_AWG(self, pulse_time, freq_729_dp, att_729_dp):
        ...
        if self.enable_pi_pulse:
            ...
            self.dds_729_radial_dp.set(self.PI_freq_729_dp)
            self.dds_729_radial_dp.set_att(self.PI_att_729_dp)

            self.dds_729_radial_sp.set(self.PI_freq_729_sp)
            self.dds_729_radial_sp.set_att(self.PI_att_729_sp)

...
class A6_Rabi_Freq_AWG_Cam(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.setattr_argument("cooling_option", EnumerationValue(["sidebandcool", "sidebandcool2mode", "opticalpumping", "sidebandcool_single_ion", "sidebandcool_Radial"], default="sidebandcool2mode"))

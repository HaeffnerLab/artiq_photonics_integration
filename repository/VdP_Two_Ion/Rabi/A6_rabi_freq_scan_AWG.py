...
class A6_Rabi_Freq_AWG_Cam(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.setattr_argument("cooling_option", EnumerationValue([
            "sidebandcool", "sidebandcool2mode", "opticalpumping", "sidebandcool_single_ion", 
            "sidebandcool_Radial", "optical_pumping_sigma"], default="sidebandcool2mode"))
    ...
    def exp_seq(self, rabi_t, freq_729_dp, ion_status_detect):
        ...
        elif self.cooling_option == "optical_pumping_sigma":

...
class A7_Sync_VdP2_Px1x2_SDF_calibrate(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.seq.calibrate_motion_SDF.build()
    ...
    def prepare(self):
        ...
        self.seq.calibrate_motion_SDF.prepare()
    ...
    def run(self):
        ...
        while i < self.num_samples:
            ...
            for iter in range(num_iter):
                ...
                if self.seq.calibrate_motion_SDF.check_interval():
                    
                    ion_status_detect=self.seq.calibrate_motion_SDF.calibrate_freq_motion(vib_mode='mode1')
                    ion_status_detect=self.seq.calibrate_motion_SDF.calibrate_freq_motion(vib_mode='mode2')#cal_freq_range=0.002*MHz)

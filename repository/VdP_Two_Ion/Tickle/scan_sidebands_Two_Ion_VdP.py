...
class scan_sidebands_Two_Ion_VdP_Tickle(EnvExperiment):
    ...
    def submit_Px1x2(self):
        expid_3_1 = {
            "file": "VdP_Two_Ion/Tickle/A7_Tickle_final_Vdp2_Wigner.py",
            "class_name": "A7_Tickle_Sync_VdP2_Wigner",
            "arguments": {
                "freq_detune":self.freq_detune,
                "enable_tickle":True,
                "vib_mode": self.vib_mode,
                "enable_img_readout":True,
                "beta_range_us":self.beta_range_us,

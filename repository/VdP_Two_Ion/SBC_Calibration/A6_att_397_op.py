...
class A6_att397op_scan_AWG_Cam(_ACFExperiment):
    ...
    def prepare(self):
        # Create datasets
        num_samples = len(self.scan_att_397_op.sequence)
        ...
        print("freq_729_dp", self.freq_729_dp)
    ...
    @kernel
    def exp_seq(self, att_397_op, ion_status_detect):
        #854 repump
        ...
        self.seq.sideband_cool.run(att_397_sigma_here=att_397_op)
    ...
    def run(self):
        ...
        i=0
        while i < len(self.scan_att_397_op.sequence):

            total_thresh_count = 0
            sample_num=0
            att_397_op =self.scan_att_397_op.sequence[i]
            num_try_save_ion = 0 
            ...
            while sample_num<self.samples_per_time:
                if ion_status_detect==1 or ion_status_detect==2:
                    ...
                    self.exp_seq( att_397_op, ion_status_detect)
                    ################################################################################
            ...
            self.experiment_data.append_list_dataset("attenuation_dB", att_397_op/dB)

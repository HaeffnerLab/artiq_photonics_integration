...
class A0_AOM_freq_scan_dp(_ACFExperiment):
    ...
    def prepare(self):
        ...
        self.experiment_data.set_list_dataset("freq_dp", num_samples, broadcast=True)
    ...
    def run(self):
        ...
        for freq_dp in self.scan_freq_729_dp.sequence:

           
            self.dds_729_dp.set(freq_dp)
            self.core.break_realtime()
            ...
            self.experiment_data.append_list_dataset("freq_dp", freq_dp)

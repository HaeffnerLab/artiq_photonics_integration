...
_DEFAULTS = {
    ...
    "frequency/729_sp":(200*MHz, "MHz"),
    "attenuation/729_sp":(  20.0,   "dB"),
    ...
    "optical_pumping/att_729_sp":(  20.0,   "dB"),
    "sideband2mode/att_729_dp":(  20.0,   "dB"),
    "sideband2mode/freq_729_sp":( 100*MHz,   "MHz"),
    "sideband2mode/att_729_sp":(  20.0,   "dB"),

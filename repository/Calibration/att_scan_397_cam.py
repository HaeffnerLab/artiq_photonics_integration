...
class AttScan397_Cam(_ACFExperiment):
    ...
    def run(self):
        ...
        for att_397 in self.scan_att_397.sequence:
            ...
            for sample_i in range(self.samples_per_freq):
                ...
                cam_input=[0.0,0.0]
                self.seq.cam_two_ions.cam_readout_raw(cam_input, att_397_here=att_397)
                num_pmt_pulses1=cam_input[0]+cam_input[1]
               
                delay(10*us)

                if self.enable_diff_mode:
                    self.seq.cam_two_ions.cam_readout_raw(cam_input, off_866=True , att_397_here=att_397)

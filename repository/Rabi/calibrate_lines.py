...
class scan_lines(EnvExperiment):
    ...
    def run(self):
        ...
        rid=self.submit_line('Sm1_2_Dm5_2', rabi_t=100, range=0.06, att_sp=27,  num_points=60)
        time.sleep(1)
        while True:
        ...
        rid=self.submit_line('Sm1_2_Dm5_2', rabi_t=1000, range=0.002, att_sp=30)
        time.sleep(1)
        while True:
            if self.check_status(rid):
                break
        ...
        rid=self.submit_line('Sm1_2_Dm1_2', rabi_t=60, range=0.06, att_sp=27,  num_points=60)
        time.sleep(1)
        while True:
            if self.check_status(rid):
                break
        ...
        rid=self.submit_line('Sm1_2_Dm1_2', rabi_t=800, range=0.002, att_sp=30)
        time.sleep(1)
        while True:
            if self.check_status(rid):
                break

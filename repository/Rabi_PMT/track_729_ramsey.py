...
class track_729AAA(_ACFExperiment):
    ...
    def run(self):
        ...
        while i<self.samples_total:
            ...
            if self.core.mu_to_seconds(now_mu())-last_time_calibrate>self.cal_interval and self.enable_calibration:
                ...
                # self.calibrate_freq_qubit(-0.5,1.5)
                # freq=self.update_729_freq(-0.5,1.5)
                # self.experiment_data.append_list_dataset("qubit_freq2_MHz", freq)

...
class A1_SDF_freq_calibrate_AWG(_ACFExperiment):
    ...
    def prepare(self):
        ...
        # Create datasets
        num_freq_samples = len(self.scan_freq.sequence)
        ...
        self.experiment_data.set_list_dataset("del_freq", num_freq_samples, broadcast=True)
    ...
    def run(self):
        ...
        delay(200*us)
        for freq_i in range(len(self.scan_freq.sequence)): 

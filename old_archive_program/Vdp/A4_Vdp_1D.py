...
class A4_Vdp_Wigner_1D(_ACFExperiment):
    ...
    def build(self): 
        ...
        self.setattr_argument(
            "freq_729_dp_rot",
            NumberValue(default=self.parameter_manager.get_param("qubit/Sm1_2_Dm5_2"), min=50*MHz, max=250*MHz, unit="MHz", precision=8),
        ...
        self.setattr_argument(
            "freq_729_sp_rot",
            NumberValue(default=self.parameter_manager.get_param("frequency/729_sp"), min=50*MHz, max=250*MHz, unit="MHz", precision=8),
            tooltip="729 double pass frequency for resonance",
            group='rotation pulse excitation'
        )
        self.setattr_argument(
            ...
            while sample_num<self.samples_per_time:
                ...
                self.seq.displacement.run(rabi_t,
                     ...
                     self.freq_729_dp, self.freq_729_sp, self.freq_729_sp_aux,
                      drive_phase_sp = 0.25, drive_phase_sp_aux = 0.25
                )

...
class A1_two_tone_Rabi_freq_scan_sp_sym(_ACFExperiment):
    ...
    def prepare(self):
        ...
        # Create datasets
        num_freq_samples = len(self.scan_freq_729_sp.sequence)
    ...
    def run(self):
        ...
        for freq_i in range(len(self.scan_freq_729_sp.sequence)):
           
            total_thresh_count = 0
            total_pmt_counts = 0
            sample_num=0

            del_freq = self.scan_freq_729_sp.sequence[freq_i]
            ...
            while sample_num<self.samples_per_time:
                ...
                self.dds_729_sp.set(self.freq_729_sp-del_freq)
                self.dds_729_sp_aux.set(self.freq_729_sp_aux+del_freq)
            ...
            self.experiment_data.append_list_dataset("frequencies_MHz", del_freq/ MHz)

...
class A1_two_tone_Rabi_time_scan(_ACFExperiment):
    ...
    #     #set frequency
    #     self.dds_729_dp.set(displace_freq_729_dp)
    #     self.dds_729_sp.set(displace_freq_729_sp)
    #     self.dds_729_sp_aux.set(displace_freq_729_sp_aux, phase=drive_phase)

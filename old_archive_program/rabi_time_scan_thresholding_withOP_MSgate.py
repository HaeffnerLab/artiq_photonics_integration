...
class RabiTimeScannThresholded_withMSgate(EnvExperiment):
    ...
    def build(self):
        ...
        self.data = ExperimentData("rabi_scan", self)
    ...
    def run(self):
        ...
        self.data.set_list_dataset("rabi_t", num_freq_samples, broadcast=True)
        ...
        for rabi_t in self.scan_rabi_t.sequence: # scan the frequency
            ...
            self.data.append_list_dataset("rabi_t", rabi_t / us)
